          ...
          render={(props) => (
            <form onSubmit={props.handleSubmit}>
              ...
              <PickupFormSection sectionName="pickupDetails" sectionTitle="Pickup Details">
                ...
                />
                <Button buttonClass="link" onClick={() => this.setState({ addDescription: true })}>
...
const mapStateToProps = (state) => {
  console.log(state);
  return {
    volunteers: (state.volunteers && state.volunteers.data) || [],
  };
};

export default connect(
  mapStateToProps,
  // { updateSelectedVolunteers: (volunteers) => change("pickupRequest", "volunteers", volunteers) },
)(PickupRequest);
